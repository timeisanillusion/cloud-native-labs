            ...
            script {
                openshift.withCluster {
                    openshift.withProject('user46') {
                        ...
                        openshift.tag("coolstore/gateway:latest", "user46/gateway-canary:latest")
                    }
                }
            }
        }
        ...
        script {
            openshift.withCluster() {
                openshift.withProject('user46') {
                    ...
                    openshift.tag("user46/gateway-canary:latest", "user46/gateway:latest")
